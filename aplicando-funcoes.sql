--- O departamento de recursos humanos precisa de um relatório para exibir o número do funcionário, o sobrenome, o salário e o salário com 15,5% de 
--- aumento (especificado como um número inteiro) de cada funcionário. Atribua o nome Novo Salário à coluna.
SELECT employee_id AS "Número", 
 ...
 FROM employees
---------------------------------------------------------------------------------------------------------------------------------------
--- Crie uma consulta que exiba o sobrenome (com a primeira letra maiúscula e todas as outras minúsculas) e o tamanho do sobrenome de todos 
--- os funcionários cujos nomes comecem com a letra J, A ou M. Atribua um nome apropriado a cada coluna. Ordene os resultados pelos sobrenomes dos funcionários.
...
SELECT salary AS "Recebe mensalmente", 
  ...
  FROM employees;
---------------------------------------------------------------------------------------------------------------------------------------
---Crie uma consulta que exiba o sobrenome e o salário de todos os funcionários. Formate o salário para defini-lo com um tamanho de 15 caracteres e preenchê-lo à 
---esquerda com o símbolo $. Atribua o nome SALARIO à coluna.
SELECT last_name AS "Sobrenome", 
       LPAD(salary, 15,'$') AS "Salário" 
  FROM employees;
---------------------------------------------------------------------------------------------------------------------------------------
---Exiba o sobrenome, a data de admissão e a data de revisão de salário de cada funcionário, que é a primeira segunda-feira após seis meses de serviço. 
---Atribua o nome REVISÃO à coluna. Formate as datas para que sejam exibidas no formato semelhante a Dia/Mês/Ano
SELECT last_name AS "Funcionário", 
